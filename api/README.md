...
```
npm i express mysql2 sequelize sequelize-typescript cors dotenv nodemon jest typescript @types/cors @types/express @types/node @types/mysql @types/jest --save
```
