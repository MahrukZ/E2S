...
import { IUploadData } from "../../src/components/pages/admin/siteManagement/upload/UploadButton";
...
describe("consumptions.service", () => {
    ...
    it("should get consumptions when function is called", async () => {
        ...
        // When
        const result = await service.findAllConsumptionsBySiteIdAndTime(
            fakeDate0,
            fakeDate1,
            1
        );
        ...
        expect(axios.get).toHaveBeenCalledWith(
            `/api/consumption/find/${fakeDate0}/${fakeDate1}/${1}`
        );
    });
});
